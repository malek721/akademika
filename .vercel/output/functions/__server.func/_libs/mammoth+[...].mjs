...
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	require_underscore_node();
	var docxReader = require_docx_reader();
	require_style_map();
	require_document_to_html().DocumentConverter;
	var convertElementToRawText = require_raw_text().convertElementToRawText;
	require_style_reader().readStyle;
	require_options_reader().readOptions;
	var unzip = require_unzip();
	require_results().Result;
